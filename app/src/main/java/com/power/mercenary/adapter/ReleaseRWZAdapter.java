...
public class ReleaseRWZAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

    public ReleaseRWZAdapter(@LayoutRes int layoutResId, @Nullable ArrayList<String> data) {
