...
public class ReleaseYXJAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

    public ReleaseYXJAdapter(@LayoutRes int layoutResId, @Nullable ArrayList<String> data) {
