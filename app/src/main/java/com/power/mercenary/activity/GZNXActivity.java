...
public class GZNXActivity extends BaseActivity implements MyZiLiPresenter.Collection {

    @BindView(R.id.left_back)
    ImageView left_back;
    @BindView(R.id.tv_save)
    TextView tvSave;
    @BindView(R.id.edt_years)
    EditText edtYears;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gznx);
    ...
    public void onViewClicked() {
        if (TextUtils.isEmpty(edtYears.getText().toString())){
            Toast.makeText(mContext, "请输入工作年限", Toast.LENGTH_SHORT).show();
        }else {
            presenter.setmZiLi("",edtYears.getText().toString(),"","","");
        }
