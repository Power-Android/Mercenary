...
public class PTAcceptSuccessActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
...
//    TextView tvOnTime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharingPop = new SharingPop(PTAcceptSuccessActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(PTAcceptSuccessActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
                ...
                new HttpManager<ResponseBean<Void>>("Home/MyTask/tijiao", this)
                        ...
                        .postRequest(new DialogCallback<ResponseBean<Void>>(this) {
                            ...
                            public void onSuccess(Response<ResponseBean<Void>> response) {
                                TUtils.showCustom(PTAcceptSuccessActivity.this, "提交成功");
                            }
                        });
                break;
        }
