package com.power.mercenary.activity.details_intask_accept;
...
public class PTAcceptInTaskActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
...
//    TextView tvOnTime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_task_detaiils_pt_intask_accept);
        ...
        sharingPop = new SharingPop(PTAcceptInTaskActivity.this, R.layout.sharing_pop_item_view);
