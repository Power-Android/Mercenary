...
public class GRAcceptInTaskActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grtask_details_intask_accept);
        ...
        sharingPop = new SharingPop(GRAcceptInTaskActivity.this, R.layout.sharing_pop_item_view);
