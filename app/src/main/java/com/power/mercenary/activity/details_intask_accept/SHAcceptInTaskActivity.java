...
public class SHAcceptInTaskActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shtask_details_intask_accept);
        ...
        sharingPop = new SharingPop(SHAcceptInTaskActivity.this, R.layout.sharing_pop_item_view);
                ...
                new HttpManager<ResponseBean<Void>>("Home/MyTask/tijiao", this)
                        ...
                        .postRequest(new DialogCallback<ResponseBean<Void>>(this) {
                            ...
                            public void onSuccess(Response<ResponseBean<Void>> response) {
                                TUtils.showCustom(SHAcceptInTaskActivity.this, "提交成功");
                            }
                        });
                break;
        }
