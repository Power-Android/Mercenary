...
public class GRPublishOutActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grdz4_task_details);
...
//        ivRecyclerView.setLayoutManager(new GridLayoutManager(this, 3));
        ...
        sharingPop = new SharingPop(GRPublishOutActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(GRPublishOutActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
