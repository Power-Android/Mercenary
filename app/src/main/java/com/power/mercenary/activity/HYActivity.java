...
public class HYActivity extends BaseActivity implements MyZiLiPresenter.Collection {
    ...
    public void onViewClicked() {
        if (TextUtils.isEmpty(edtHangye.getText().toString())){
            Toast.makeText(mContext, "请输入所属行业", Toast.LENGTH_SHORT).show();
        }else {
            presenter.setmZiLi(edtHangye.getText().toString(),"","","","");
        }
    }
