package com.power.mercenary.activity.details_out_publish;
...
public class PTPublishOutActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
...
//    TextView tvOnTime;
    ...
    TextView tvItemNum;
    @BindView(R.id.act_task_detaiils_beginAddress)
    TextView tvBeginAddress;
    @BindView(R.id.act_task_detaiils_endAddress)
    TextView tvEndAddress;
    @BindView(R.id.act_task_detaiils_toTime)
    TextView tvToTime;
    @BindView(R.id.act_task_detaiils_transPort)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task4_details);
        ...
        sharingPop = new SharingPop(PTPublishOutActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(PTPublishOutActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
...
//                    PersonalDataActivity.invoke(this, publisherId);
            ...
            case R.id.act_task_detaiils_publishBtn:
                ...
                publishPresenter.putTaskRequest(taskId, 0);
                break;
        }
    }
...
//            tvOnTime.setText("任务有效期：" + datas.getValidity_time() + "天");
            ...
            tvItemName.setText(datas.getItemname());

            tvItemNum.setText(datas.getNumbers() + "");

            tvBeginAddress.setText(datas.getBegin_address());

            tvEndAddress.setText(datas.getEnd_address());

            tvToTime.setText(MyUtils.stampToDate(datas.getDelivery_time()));

            tvTransPort.setText(datas.getTransport());
