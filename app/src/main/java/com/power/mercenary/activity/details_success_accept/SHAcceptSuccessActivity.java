...
public class SHAcceptSuccessActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shtask_details);
        ...
        sharingPop = new SharingPop(SHAcceptSuccessActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(SHAcceptSuccessActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
                ...
                new HttpManager<ResponseBean<Void>>("Home/MyTask/tijiao", this)
                        ...
                        .postRequest(new DialogCallback<ResponseBean<Void>>(this) {
                            ...
                            public void onSuccess(Response<ResponseBean<Void>> response) {
                                TUtils.showCustom(SHAcceptSuccessActivity.this, "提交成功");
                            }
                        });
                break;
        }
