...
public class SHPublishAppraiseActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shtask_accept_appraise);
        ...
        sharingPop = new SharingPop(SHPublishAppraiseActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(SHPublishAppraiseActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
