...
public class GZPublishOutActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gz4_task_details);
        ...
        sharingPop = new SharingPop(GZPublishOutActivity.this, R.layout.sharing_pop_item_view);
