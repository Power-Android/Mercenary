package com.power.mercenary.activity.details_audit_accept;
...
public class PTAcceptAuditActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
...
//    TextView tvOnTime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharingPop = new SharingPop(PTAcceptAuditActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(PTAcceptAuditActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
