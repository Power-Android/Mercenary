...
public class GZPublishAppraiseActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gztask_accept_appraise);
        ...
        sharingPop = new SharingPop(GZPublishAppraiseActivity.this, R.layout.sharing_pop_item_view);
