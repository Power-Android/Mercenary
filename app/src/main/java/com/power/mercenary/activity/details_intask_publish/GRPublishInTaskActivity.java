...
public class GRPublishInTaskActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grdz2_task_details);
        ...
        sharingPop = new SharingPop(GRPublishInTaskActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(GRPublishInTaskActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
