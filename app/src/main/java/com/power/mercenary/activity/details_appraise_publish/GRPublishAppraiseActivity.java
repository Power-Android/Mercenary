...
public class GRPublishAppraiseActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grtask_accept_appraise);
        ...
        sharingPop = new SharingPop(GRPublishAppraiseActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(GRPublishAppraiseActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
