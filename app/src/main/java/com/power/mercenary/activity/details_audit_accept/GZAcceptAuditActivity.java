...
public class GZAcceptAuditActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharingPop = new SharingPop(GZAcceptAuditActivity.this, R.layout.sharing_pop_item_view);
