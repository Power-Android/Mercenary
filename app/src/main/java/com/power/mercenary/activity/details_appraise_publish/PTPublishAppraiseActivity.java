...
public class PTPublishAppraiseActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
...
//    TextView tvOnTime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pttask_accept_appraise);
        ...
        sharingPop = new SharingPop(PTPublishAppraiseActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(PTPublishAppraiseActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
