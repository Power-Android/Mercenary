...
public class PTPublishAuditActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack, PublishPresenter.PublishCallBack {
...
//    TextView tvOnTime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task3_details);
        ...
        sharingPop = new SharingPop(PTPublishAuditActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(PTPublishAuditActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
    }
