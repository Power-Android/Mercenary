...
public class GZAcceptInTaskActivity extends BaseActivity implements View.OnClickListener, TaskDetailsPresenter.TaskDetailsCallBack, DetailsPeopleAdapter.DetailsPepCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gztask_details_intask_accept);
        ...
        sharingPop = new SharingPop(GZAcceptInTaskActivity.this, R.layout.sharing_pop_item_view);
        ...
        ivIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalDataActivity.invoke(GZAcceptInTaskActivity.this, taskDetailsBean.getPublisher_id());
            }
        });
        actTaskDetaiilsPrivateMsg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GZAcceptInTaskActivity.this, PersonalDataActivity.class);
                ...
                new HttpManager<ResponseBean<Void>>("Home/MyTask/tijiao", this)
                        ...
                        .postRequest(new DialogCallback<ResponseBean<Void>>(this) {
                            ...
                            public void onSuccess(Response<ResponseBean<Void>> response) {
                                TUtils.showCustom(GZAcceptInTaskActivity.this, "提交成功");
                            }
                        });
                break;
        }
