...
public class GZTaskZhonDetailsActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gz_task_zhon_details);
...
//        recycler_liu_yan.setAdapter(changegameAdapter);
        sharingPop = new SharingPop(GZTaskZhonDetailsActivity.this,R.layout.sharing_pop_item_view);
