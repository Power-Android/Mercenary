 ...
 * admin  2018/7/23 wan
 */
public class MessageTavernFragment extends BaseFragment implements WanRecyclerView.PullRecyclerViewCallBack, MessageTaskAdapter.OnItemClickListener {
    ...
    public void onItemClickListener() {
        ChatPushActivity.invoke(getActivity(), "酒馆");
    }
}