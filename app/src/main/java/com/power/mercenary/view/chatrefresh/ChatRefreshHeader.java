 ...
 * admin  2018/7/24 wan
 */
public class ChatRefreshHeader extends BaseHeader {
...
//    private ImageView headerArrow;
    ...
    public ChatRefreshHeader(Context context) {
        this(context, R.drawable.rotate_chat_refresh, R.drawable.arrow);
    }

    public ChatRefreshHeader(Context context, int rotationSrc, int arrowSrc) {
...
//        mRotateDownAnim.setFillAfter(true);
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.view_chat_refresh, viewGroup, true);
...
//        headerArrow = (ImageView) view.findViewById(R.id.default_header_arrow);
        headerProgressbar = (ProgressBar) view.findViewById(R.id.view_chat_progressBar);
